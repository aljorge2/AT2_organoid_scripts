...
#SBATCH -e /tscc/projects/ps-epigen/users/a2jorgensen/sandbox/250225_humanAT2_organoids/ErrorLog/250320_genelist_organoid.e-%J
#SBATCH -o /tscc/projects/ps-epigen/users/a2jorgensen/sandbox/250225_humanAT2_organoids/OutputLog/250320_genelist_organoid.o-%J
...
SEU_OBJ="/tscc/projects/ps-epigen/users/a2jorgensen/sandbox/250225_humanAT2_organoids/data/rds_objs/250322_lib_donor_batch_SCT_3libs.RDS"

# ident to group by dotplots by #seurat_clusters, wsnn_res.0.25, RNA_snn_res.0.5 
IDENT="seurat_clusters"

# output path
OUT_PATH="/tscc/projects/ps-epigen/users/a2jorgensen/sandbox/250225_humanAT2_organoids/data/Annotating/genelists_three_libs_donor_lib_batch/"
