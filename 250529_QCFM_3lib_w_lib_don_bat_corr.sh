...
#SBATCH --qos=condo
#SBATCH -e /tscc/projects/ps-epigen/users/a2jorgensen/AT2_organoid/ErrorLog/250529_QC_organoid.e-%J
#SBATCH -o /tscc/projects/ps-epigen/users/a2jorgensen/AT2_organoid/OutputLog/250529_QC_organoid.o-%J
...
### INPUTS 
# object path
SEU_OBJ="/tscc/projects/ps-epigen/users/a2jorgensen/AT2_organoid/data/SCT/250507_corr_demux_add/250529_lib_donor_batch_SCT_3libs.RDS"
# output path
OUT_PATH="/tscc/projects/ps-epigen/users/a2jorgensen/AT2_organoid/data/Quality/250529_QC_reports/"
# celltype
#CELLTYPE=""
# assay to test
ASSAY="RNA"
